...
3. `python scripts/run_baseline.py --model logistic_tfidf`
4. `python scripts/run_baseline.py --model distilbert`
5. `python scripts/run_shift_eval.py --run-id <id>`
6. `python scripts/build_report.py --experiment-group <name>`
