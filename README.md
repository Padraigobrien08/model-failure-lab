...
> export and the `openai-compat` adapter. Clone until the badge below reads `0.13.0`.
...
Pre-1.0 (`0.13.0`, public beta). Versioning intent: patch = fixes/docs, minor = CLI-compatible additions, breaking
