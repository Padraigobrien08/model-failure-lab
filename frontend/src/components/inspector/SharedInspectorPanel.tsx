      ...
      <div className="space-y-2">
        ...
        {entity ? (
          ...
          <div className="space-y-1">
            <h2 className="text-lg font-semibold tracking-[-0.03em] text-foreground">{placeholderTitle}</h2>
            <p className="text-sm leading-6 text-muted-foreground">{placeholderMessage}</p>
          </div>
        )}
      </div>
