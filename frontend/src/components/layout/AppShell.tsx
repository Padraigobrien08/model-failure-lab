        ...
        <aside className="hidden rounded-[24px] border border-border/70 bg-card/78 p-4 shadow-rail backdrop-blur-sm lg:block">
          <Card className="border-none bg-transparent shadow-none">
            <CardHeader className="px-0 pb-4 pt-0">
              <CardDescription>Live inspector</CardDescription>
              <CardTitle>Selected lineage and manifest truth</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 px-0 pb-0">
              {inspectorModel ? (
                <EvidenceDrawer
                  ...
                  onClose={
                    routeContext.isEvidenceDrawerOpen ||
                    routeContext.selectedRunId !== null ||
                    routeContext.selectedArtifact !== null
                ...
                <>
                  ...
                  <div className="rounded-[18px] border border-border/80 bg-background/55 p-4">
                    ...
                    <p className="mt-2 text-sm leading-6 text-foreground">
                      Selection-driven provenance is unavailable until the manifest and final
                      robustness package finish loading.
                    </p>
                  </div>
                </>
              )}
